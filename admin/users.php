    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                $result = mysqli_query($connection, $query) or die("Failrd");
                ...
                ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class='delete'><a onclick="return confirm('Are You Sure ?')" href='delete-user.php?id=<?php echo $row['user_id'] ?>'>
                    ...
                    $result2 = mysqli_query($connection, $query2) or die("Pagination Query Failed !!");
